...
public abstract class NumberPredicate extends AbstractPredicate {
    ...
    public <T extends MinecraftPredicate> NumberPredicate(ResourceLocation identifier, MapCodec<T> codec, Object valueA, Object valueB) {
    ...
    public static final class LessThan extends NumberPredicate {
        public static final ResourceLocation ID = new ResourceLocation("less_than");
    ...
    public static final class LessEqual extends NumberPredicate {
        public static final ResourceLocation ID = new ResourceLocation("less_or_equal");
    ...
    public static final class MoreThan extends NumberPredicate {
        public static final ResourceLocation ID = new ResourceLocation("more_than");
    ...
    public static final class MoreEqual extends NumberPredicate {
        public static final ResourceLocation ID = new ResourceLocation("more_or_equal");
